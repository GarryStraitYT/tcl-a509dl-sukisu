...
//add begin by haimei.liu.2021/07/13.task:11332054.aw87359 porting.
#if (defined CONFIG_SND_SOC_AW87935_V2)
enum {
	AW87XXX_OFF_MODE = 0,
...
static void Ext_Speaker_Amp_Change_aw87359(bool enable)
{
...
#endif
//add end by haimei.liu.2021/07/13.task:11332054.aw87359 porting.
				       ...
				       int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
...
#ifdef CONFIG_SND_CLASS_K_PA_SUPPORT
#ifdef CONFIG_TCT_PROJECT_BUFFALO
		AudDrv_GPIO_EXTAMP_Select(true, 2);
#elif defined CONFIG_TCT_PROJECT_ODINTMO
		AudDrv_GPIO_EXTAMP_Select(true, 2);
		AudDrv_GPIO_EXTAMP2_Select(true, 2);
#else
		...
		sia81xx_start();
#endif
//add by haimei.liu.2021/07/13.task:11332054.aw87359 porting.
#ifdef CONFIG_SND_SOC_AW87935_V2
        Ext_Speaker_Amp_Change_aw87359(true);
#endif
//add end by haimei.liu.2021/07/13.task:11332054.aw87359 porting.
//begin add by bo_liu
...
//endi add by bo_liu
	...
	case SND_SOC_DAPM_PRE_PMD:
...
#elif defined CONFIG_TCT_PROJECT_ODINTMO
		AudDrv_GPIO_EXTAMP_Select(false, 2);
		AudDrv_GPIO_EXTAMP2_Select(false, 2);
#else
		...
		sia81xx_stop();
#endif
//add begin by haimei.liu.2021/7/13.task:11332054.aw87359 porting.
#ifdef CONFIG_SND_SOC_AW87935_V2
        Ext_Speaker_Amp_Change_aw87359(false);
#endif
//add end by haimei.liu.2021/7/13.task:11332054.aw87359 porting.
//begin add by bo_liu
#ifdef CONFIG_SND_SOC_AW87XXX
...
//bo_liu add start
#ifdef CONFIG_SND_SOC_AW87XXX_V2
...
//bo_liu add start
#ifdef CONFIG_SND_SOC_AW87XXX_V2
       ret = aw87xxx_add_codec_controls(codec_component);
       if (ret < 0) {
