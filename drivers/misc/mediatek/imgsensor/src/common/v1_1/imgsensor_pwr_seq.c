...
//odin5g
#if defined(GC08A3ODIN5GTMO_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC08A3ODIN5GTMO_MIPI_RAW,
		{
			{PDN, Vol_Low, 1},
			{RST, Vol_Low, 1},
...
#endif
#if defined(GC5035ODIN5GTSP_MIPI_RAW)
        {
                SENSOR_DRVNAME_GC5035ODIN5GTSP_MIPI_RAW,
                {
...
#endif
#if defined(HI846ODIN5G_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI846ODIN5G_MIPI_RAW,
		{
			{PDN, Vol_Low, 1},
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC5035ODIN5GUI_MIPI_RAW)
        {
                SENSOR_DRVNAME_GC5035ODIN5GUI_MIPI_RAW,
                {
                        {PDN, Vol_Low, 1, Vol_Low, 1},
                        {RST, Vol_Low, 1, Vol_Low, 1},
                        {DOVDD, Vol_1800, 1, Vol_Low, 1},
...
#if defined(TSPPHCP1423_HI1336_MIPI_RAW)
	{
		SENSOR_DRVNAME_TSPPHCP1423_HI1336_MIPI_RAW,
		{
			{PDN,   Vol_Low,  0},
			{RST,   Vol_Low,  1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(TSPPHCP1367_HI1336_MIPI_RAW)
	{
		SENSOR_DRVNAME_TSPPHCP1367_HI1336_MIPI_RAW,
		{
			{RST,   Vol_Low,  1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
#if defined(SHNCND42B_S5K3L6_MIPI_RAW)
	{
		SENSOR_DRVNAME_SHNCND42B_S5K3L6_MIPI_RAW,
		{
...
#endif
//add by yixuan cheng for buffalo bring up
#if defined(HI1336BUFFALO_MIPI_RAW)
	{
		SENSOR_DRVNAME_HI1336BUFFALO_MIPI_RAW,
		{
			{PDN,   Vol_Low,  0},
			{RST,   Vol_Low,  1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC02M1BBUFFALO_MIPI_MONO)
	{
		SENSOR_DRVNAME_GC02M1BBUFFALO_MIPI_MONO,
		{
			{SensorMCLK, Vol_High, 1},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 1},
...
#endif
#if defined(GC02M1BUFFALO_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1BUFFALO_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 1},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 1},
...
#endif
#if defined(S5K4H7BUFFALO_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7BUFFALO_MIPI_RAW,
		{
			{PDN, Vol_Low, 1},
			{RST, Vol_Low, 1},
...
#endif
/*Begin zihao.li for [Task][BUTF-4165] Buffalotf rename standard camera name on 20220111*/
...
#endif
#if defined(CXTVC12851_GC02M1B_MIPI_MONO)
	{
		SENSOR_DRVNAME_CXTVC12851_GC02M1B_MIPI_MONO,
		{
			{SensorMCLK, Vol_High, 1},
			{PDN, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(CXTVC12852_GC02M1_MIPI_RAW)
	{
		SENSOR_DRVNAME_CXTVC12852_GC02M1_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 1},
			{PDN, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(SHNBF219C_GC02M1_MIPI_RAW)
	{
		SENSOR_DRVNAME_SHNBF219C_GC02M1_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 1},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 1},
...
#endif
/*End   zihao.li for [Task][BUTF-4165] Buffalotf rename standard camera name on 20220111*/
#if defined(GC08A3BUFFALO_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC08A3BUFFALO_MIPI_RAW,
		{
			{PDN, Vol_Low, 1},
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
...
#if defined(S5KJN1CHALLENGER_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KJN1CHALLENGER_MIPI_RAW,
		{
			{PDN,   Vol_Low,  0},
			{RST,   Vol_Low,  1},
			{DOVDD, Vol_1800, 1},
