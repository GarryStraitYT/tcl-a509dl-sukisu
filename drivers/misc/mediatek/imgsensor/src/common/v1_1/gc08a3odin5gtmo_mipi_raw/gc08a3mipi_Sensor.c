...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3_ODIN5GTMO_SENSOR_ID,       //+3
...
bool check_gc08a3_otp(void)
{
	...
	if(otpStatus == EEPROM_MODULEINFO_FLAG)
	{
		if (check_sum((kal_uint8 *)pModuleInfo, sizeof(moduleInformation_struct)))
		{
			...
			if (pModuleInfo->moduleID == 0x43 && pModuleInfo->LENSID == 0xC2 && pModuleInfo->VCMID == 0xD2 && pModuleInfo->DriverICID == 0x13)
			{
...
UINT32 GC08A3_ODIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
