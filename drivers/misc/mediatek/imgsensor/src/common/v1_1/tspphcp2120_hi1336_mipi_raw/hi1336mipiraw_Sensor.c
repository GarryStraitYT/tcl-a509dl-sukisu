...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = TSPPHCP2120_HI1336_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{ 4224, 3136,   0, 382, 4224, 2372,	 4224, 2372,  8,  2, 4208, 2368, 0, 0, 4208, 2368},
	{ 4224, 3136,   0, 482, 4224, 2172,  1408,  724,  64, 2, 1280,  720, 0, 0, 1280,  720},		// VIDEO (4208 x 3120)
	{ 4224, 3136,   0, 116, 4224, 2904,	  704,  484,  32, 2,  640,  480, 0, 0,  640,  480},
	{ 4224, 3136,   0,   6, 4224, 3124,	 4224, 3124,  8,  2, 4208, 3120, 0, 0, 4208, 3120},		// MTF (4208 x 3120)
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3]=
{
	/* Preview mode setting */
	 {0x02, //VC_Num
	  ...
	  0x01, 0x2B, 0x0000, 0x0000,   // VC2 PDAF
	...
	/* Video mode setting */
	 {0x02, //VC_Num
	  ...
	  0x00, 0x00, 0x0000, 0x0000,	// VC1 MVHDR
	  0x01, 0x2B, 0x0100, 0x0250,   // VC2 PDAF
	  0x00, 0x00, 0x0000, 0x0000},	// VC3 ??
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info[2] =
{
	...
	},
	{
		...
		.i4PosR =	{
				{61,0}, {61,16}, {69,12}, {69,28},
				{77,0}, {77,16}, {85,12}, {85,28},
		},
		.i4PosL =	{
				{61,4}, {61,20}, {69, 8}, {69,24},
				{77,4}, {77,20}, {85, 8}, {85,24},
		},
		.i4BlockNumX = 128,
		.i4BlockNumY = 74,
		.i4LeFirst = 0,
...
static void set_shutter_frame_length(kal_uint32 shutter,kal_uint16 frame_length,kal_bool auto_extend_en)
{
	...
	pr_err("cyx474 Exit! shutter =%d, framelength =%d/%d, dummy_line=%d,\n",shutter, imgsensor.frame_length, frame_length, dummy_line);
	...
	write_cmos_sensor_8(0x020D, (shutter & 0xFF0000) >> 16 );
	write_cmos_sensor(0x020A, shutter);
	pr_err("cyx 510Exit! shutter =%d, framelength =%d/%d, dummy_line=%d,\n",
...
bool check_tspphcp2120hi1336_otp(void);
		...
		do {
			*sensor_id = return_sensor_id();
			...
			imgsensor.i2c_write_id, *sensor_id);
				...
				if(check_tspphcp2120hi1336_otp())
				{
					LOG_INF("HI1336,check OTP pass\n");		
					sprintf(CamOTPB_module_name,"1");	
...
{
	UINT16 nTestpatternEnablecheck = (read_cmos_sensor(0x0b04)<<8) | read_cmos_sensor(0x0b05);
	UINT16 nTestpatternEnb =0x01;
	LOG_INF("set_test_pattern_mode enable: %d", enable);

	if (enable) {
		nTestpatternEnablecheck|= nTestpatternEnb;
		LOG_INF("nTestpatternEnablecheck = %d, nTestpatternEnb = %d\n",nTestpatternEnablecheck,nTestpatternEnb);
		//write_cmos_sensor(0x1038, 0x0000); //mipi_virtual_channel_ctrl
		//write_cmos_sensor(0x1042, 0x0008); //mipi_pd_sep_ctrl_h, mipi_pd_sep_ctrl_l
		write_cmos_sensor(0x0b04, nTestpatternEnablecheck);
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME:
		pr_err("cyxsset_shutter_frame_length LE, SE\n");
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	"HI1336:TSP:13M:ASA1300092C1",
	0,//main:0 front:1 main2:2 front2:3  main3:4 
	{
		{PDN,   Vol_Low,  0},
		{RST,   Vol_Low,  1},
		{DOVDD, Vol_1800, 1},
