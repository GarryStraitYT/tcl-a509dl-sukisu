...
#include "tsps8f9074_s5k4h7_mipi_raw_sensor.h"
#include "tsps8f9074_s5k4h7_mipi_raw_eeprom.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = TSPS8F9074_S5K4H7_SENSOR_ID,	/*S5K4H7_SENSOR_ID = 0x487B */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
    ...
    {3264, 2448,   0,   0, 3264, 2448, 3264, 2448, 0000, 0000, 3264, 2448, 0, 0, 3264, 2448},	// MTF
};
...
static kal_uint8 S5K4H7_otp_check = 0;
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	S5K4H7_otp_check = S5K4H7_otp_update();
	printk("S5K4H7_otp_check:%d", S5K4H7_otp_check);
	if((S5K4H7_otp_check == 1) && (lsc_otp_checksum())){
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	S5K4H7_otp_update();
	write_cmos_sensor_8(0x0B00, 0x01);// add by yixuan.cheng enable lsc shading otp			
	pr_err("lsc_enable\n");
	spin_lock(&imgsensor_drv_lock);
...
UINT32 TSPS8F9074_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
