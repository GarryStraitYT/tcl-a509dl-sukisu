...
static bool read_shncnd42b_eeprom(kal_uint16 addr, BYTE *data, int size)
{
	int i = 0;
	int offset = addr;
	int ret;
...
bool check_shncnd42b_otp(void)
{
	...
	read_shncnd42b_eeprom(MODULE_INFO_START_ADDR, (BYTE *)pModuleInfo, sizeof(moduleInformation_struct));
	...
	read_shncnd42b_eeprom(AWB_INFO_START_ADDR, (BYTE *)pAWBInfo,sizeof(awb_struct));
	...
	read_shncnd42b_eeprom(LSC_INFO_START_ADDR, (BYTE *)pLSCInfo,sizeof(lsc_struct));
	...
	read_shncnd42b_eeprom(AF_INFO_START_ADDR, (BYTE *)pAFInfo,sizeof(af_struct));
	...
	read_shncnd42b_eeprom(PDAF_INFO_START_ADDR, (BYTE *)pPDAFInfo,sizeof(pdaf_struct));
