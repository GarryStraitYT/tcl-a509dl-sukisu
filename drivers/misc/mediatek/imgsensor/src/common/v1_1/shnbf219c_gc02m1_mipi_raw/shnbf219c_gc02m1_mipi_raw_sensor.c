...
#include "shnbf219c_gc02m1_mipi_raw_sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SHNBF219C_GC02M1_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			*sensor_id = (read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)+2;
...
UINT32 SHNBF219C_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
