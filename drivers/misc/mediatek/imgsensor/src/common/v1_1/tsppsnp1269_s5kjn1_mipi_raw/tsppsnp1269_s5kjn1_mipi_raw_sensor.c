...
#include "tsppsnp1269_s5kjn1_mipi_raw_sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	...
	.min_gain = 64, /*1x gain*/
	.max_gain = 4096, /*16x gain*/   //zhongzhu modify,the sensor should support 64x gain 20201/12/21
	.min_gain_iso = 100,
	.gain_step = 2,
	.exp_step = 2,
	.gain_type = 2,
	...
	.i2c_speed = 1000,
	.i2c_addr_table = {0x7a,0x5a, 0x20,0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{ 8160, 6144,    1520, 1632, 5120, 2880, 1280,720,  0,  0, 1280,  720,    0,    0, 1280,  720}, // high speed new
	{ 8160, 6144,    0,    0, 8160, 6144, 4080, 3072,  0, 388, 4080, 2296,    0,    0, 4080, 2296}, // slim video
	{ 8160, 6144,    0,    0, 8160, 6144, 8160, 6144,  0,   0, 8160, 6144,    0,    0, 8160, 6144}, // custom3 for remosaic
};
...
static kal_uint16 custom3_setting_array[] = {
	...
	0x0386,0x0001,
	0x0110,0x1002,
	0x0114,0x0300,//#ifdef FPT_PDAF_SUPPORT #endif
	0x0116,0x3000,
	0x0136,0x1800,
	0x013E,0x0000,
	0x0300,0x0006,
	...
	0x0202,0x0100,
	0x0200,0x0100,
	0x0D00,0x0100,//#ifdef FPT_PDAF_SUPPORT #endif
	0x0D02,0x0001,
	0x0D04,0x0002,
	0x6226,0x0000,
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4080_3072 =
{
    .i4OffsetX = 8,
    .i4OffsetY = 8,
    .i4PitchX  = 8,
    .i4PitchY  = 8,
    .i4PairNum = 4,//i4PairNum=(i4PitchY/Density_Y)*(i4PitchX/Density_X)=
    .i4SubBlkW = 8,
    .i4SubBlkH = 2,
	.i4BlockNumX = 508,
	.i4BlockNumY = 382,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4080_2296 =
{
	...
	.i4BlockNumY = 286,
	.iMirrorFlip = 0,
	.i4PosL = {{11,  4}, { 9, 7}, {13, 8}, {15, 11} },
	.i4PosR = {{10,  4}, { 8, 7}, {12, 8}, {14, 11} },
};

static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[2] = {
	/* Preview/Capture mode setting,PD output size is 288(Pixel)*1728 */
	{
		0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
		0x00, 0x2B, 0x0FF0, 0xC00,  // VC0 Maybe image data?
		0x00, 0x00, 0x0000, 0x0000, // VC1 MVHDR
		0x01, 0x30, 0x027C, 0x0BF0, // VC2 PDAF
		0x03, 0x00, 0x0000, 0x0000  // VC3 ??
	},
	/* Video mode mode setting,PD output size is 288(Pixel)*1728 */
	{
...
static void sensor_init(void)
{
	...
	if(hwggc1.hwGGCFlag){
		kal_uint16 *phwGGCData = (kal_uint16 *)&hwggc1.hwGGCData[0];
        LOG_INF("[%s] hwGGCFlag set", __func__);

		write_cmos_sensor(0x6028, 0x2400);
		write_cmos_sensor(0x602A, 0x0CFC);
		/* Begin binchang.liang optimize ggc write reg operation 2021/11/18 */
		hwggc_table_write_cmos_sensor(0x6F12,phwGGCData,sizeof(hwggc1.hwGGCData)/2);
		/* End binchang.liang optimize ggc write reg operation 2021/11/18 */
	}
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff)
    {
		...
		do 
		{
			*sensor_id = return_sensor_id();
			...
			{
				LOG_INF("new i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id, *sensor_id, imgsensor_info.sensor_id);
				if(check_tsp_s5kjn1new_otp())
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	case MSDK_SCENARIO_ID_CUSTOM3:
		sensor_info->PDAF_Support = 0;// yitaoyang added at 20210908
...
//			case MSDK_SCENARIO_ID_CUSTOM3:
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
			...
			case MSDK_SCENARIO_ID_CUSTOM4:
			case MSDK_SCENARIO_ID_CUSTOM5:
				memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_4080_3072, sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
