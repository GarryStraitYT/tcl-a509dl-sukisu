...
#include "f_shinetech_gc5035_mipi_raw.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "f_shinetech_gc5035_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = F_SHINETECH_GC5035_SENSOR_ID, /*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint16 gc5035_table_write_cmos_sensor(
...
static void gc5035_gcore_read_dpc(void)
{
    ...
    switch(GC5035_OTP_GET_2BIT_FLAG(dpcFlag, 0)) {
        ...
        case GC5035_OTP_FLAG_VALID: {
            ...
            pDPC->total_num = gc5035_otp_read_byte(GC5035_OTP_DPC_TOTAL_NUMBER_OFFSET) + gc5035_otp_read_byte(GC5035_OTP_DPC_ERROR_NUMBER_OFFSET);
    ...
    for(idx = 0; idx < GC5035_OTP_GROUP_CNT; idx++) {
        switch(GC5035_OTP_GET_2BIT_FLAG(flag, 2 * (1 - idx))) {
            ...
            case GC5035_OTP_FLAG_VALID: {
                ...
                module_start_offset = GC5035_OTP_MODULE_DATA_OFFSET + GC5035_OTP_GET_OFFSET(idx * GC5035_OTP_MODULE_DATA_SIZE);
    ...
    for(idx = 0; idx < GC5035_OTP_GROUP_CNT; idx++) {
        switch(GC5035_OTP_GET_2BIT_FLAG(flag, 2 * (1 - idx))) {
            ...
            case GC5035_OTP_FLAG_VALID: {
                ...
                wb_start_offset = GC5035_OTP_WB_DATA_OFFSET + GC5035_OTP_GET_OFFSET(idx * GC5035_OTP_WB_DATA_SIZE);
        ...
        switch(GC5035_OTP_GET_2BIT_FLAG(flag, 2 * (3 - idx))) {
            ...
            case GC5035_OTP_FLAG_VALID: {
                ...
                golden_start_offset = GC5035_OTP_GOLDEN_DATA_OFFSET + GC5035_OTP_GET_OFFSET(idx * GC5035_OTP_GOLDEN_DATA_SIZE);
...
static kal_uint8 gc5035_otp_identify(void)
{
    ...
    if((module_info.module_id == 0x4) && (module_info.lens_id == 0x2) && (module_otp_flag == 1) && (wb_otp_flag == 1) && (wb_golden_otp_flag == 1)) {
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_gc5035[] = {
    /* SYSTEM */
    0xfc, 0x01,
    0xf4, 0x40,
    0xf5, 0xe9,
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_gc5035[] = {
    /* System */
    0xfe, 0x00,
    0x3e, 0x01,
    0xfc, 0x01,
