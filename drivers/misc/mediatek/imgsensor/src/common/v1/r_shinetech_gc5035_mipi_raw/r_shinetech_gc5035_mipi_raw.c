...
#include "r_shinetech_gc5035_mipi_raw.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "r_shinetech_gc5035_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = R_SHINETECH_GC5035_SENSOR_ID, /*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint8 gc5035_otp_identify(void)
{
    ...
    printk("bo_liu, rear camera gc5035, module_info.module_id = 0x%x, module_info.lens_id = 0x%x, module_otp_flag = %d, wb_otp_flag = %d, wb_golden_otp_flag = %d\n", module_info.module_id, module_info.lens_id, module_otp_flag, wb_otp_flag, wb_golden_otp_flag);

    if((module_info.module_id == 0x43) && (module_info.lens_id == 0xe1) && (module_otp_flag == 1) && (wb_otp_flag == 1) && (wb_golden_otp_flag == 1)) {
        printk("bo_liu, rear camera gc5035, GC5035A_OTP_Flag = 1\n");
        GC5035A_OTP_Flag = 1;
    } else {
        printk("bo_liu, rear camera gc5035, GC5035A_OTP_Flag = 0\n");
        GC5035A_OTP_Flag = 0;
    }
