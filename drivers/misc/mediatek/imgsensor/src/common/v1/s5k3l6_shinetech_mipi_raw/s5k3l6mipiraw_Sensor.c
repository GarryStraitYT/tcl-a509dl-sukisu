...
#else
//6 M * 24fps, modify for 13M*24fps 0809
static kal_uint16 addr_data_pair_custom1_3l6[] = {
	0x0344, 0x0008,
	0x0346, 0x0008,
	0x0348, 0x1077,
...
extern void S5K3L6_otp_cali(void);
extern void S5K3L6_pdaf_cali(void);
extern char CamNameB_module_name[256];
//extern char CamOTPB_module_name [256];
extern int S5K3L6_OTP_Flag;
extern int S5K3L6_pdaf_Flag;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	 ...
	 */
	pr_err("get_imgsensor_id s5k3l6mipi");
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				S5K3L6_otp_cali();
				S5K3L6_pdaf_cali();
				sprintf(CamNameB_module_name,"S5K3L6:SHINETECH:13M_AF");
				#ifdef TARGET_BUILD_MMITEST		
				if((S5K3L6_OTP_Flag==1)&&(S5K3L6_pdaf_Flag==1)){
...
/*
	...
	sensor_info->PDAF_Support =2;//mt6739 mt6761
#else
	sensor_info->PDAF_Support =
		2;//mt6762 mt6763 mt6765 use pdo
#endif
*/
#endif
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1;
			break;
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			/* video & capture use same setting*/ //modify for video power high
...
UINT32 S5K3L6_SHINETECH_MIPI_RAW_SensorInit(
