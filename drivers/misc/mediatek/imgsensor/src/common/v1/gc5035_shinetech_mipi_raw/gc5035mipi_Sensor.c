...
static kal_uint8 gc5035_otp_identify(void)
{
	...
	if((module_info.module_id == 0x43) && (module_info.lens_id == 0x34) && (module_otp_flag == 1) && (wb_otp_flag == 1) && (wb_golden_otp_flag == 1))
	{
...
#if 1
					sprintf(CamNameF_module_name,"GC5035A:SHINETECH:5M_FF");
