 ...
 *============================================================================
 *
 * Version:  V20221116144349 by GC-S-TEAM
 *
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SWLU7166_GC13A0_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
  ...
  { 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 2104, 1560, 0, 0, 2104, 1560}, /* Preview */
	...
	{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 2104, 1560, 0, 0, 2104, 1560}, /* hs video */
	{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 92, 240, 1920, 1080, 0, 0, 1920, 1080}  /* slim video */
};
...
static kal_uint16 gc13a0_1920x1080_addr_data[] = {
/*system*/
	0x031c, 0x20,
	0x0337, 0x05,
	0x0335, 0x05,
...
{
	gc13a0_stream_off();
	table_write_cmos_sensor(gc13a0_1920x1080_addr_data,
		sizeof(gc13a0_1920x1080_addr_data)/sizeof(kal_uint16));
	gc13a0_stream_on();
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_err("[gc13a0_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
