...
#include "r_ewelly_hi556_mipi_raw.h"

#define PFX "r_ewelly_hi556_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = R_EWELLY_HI556_SENSOR_ID,
...
static void read_hi556_otp(void)
{
	...
	if ((otp_flag != 0) && (awb_flag != 0) && (module_id == 0x44) && (lens_id == 0xb3) && (check_sum == check_sum_cal) && (check_sum_awb == check_sum_awb_cal))
	{
		hi556_otp_flag = 1;
	}
	else
