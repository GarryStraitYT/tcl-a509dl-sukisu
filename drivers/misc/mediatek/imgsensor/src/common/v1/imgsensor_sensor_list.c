...
#define RAW_INFO(_id, name, SensorInit)\
    { \
     _id, name, \
    SensorInit,\
    #name,\
...
/*End yaqin.zhang add for sonatatf bring up 2022/7/4*/
	...
	RAW_INFO(TSPSCF0002_S5K3L6_SENSOR_ID,
	SENSOR_DRVNAME_TSPSCF0002_S5K3L6_MIPI_RAW,
	TSPSCF0002_S5K3L6_MIPI_RAW_SensorInit),
#endif
#if defined(SHNBF811B_GC08A3_MIPI_RAW)
	RAW_INFO(SHNBF811B_GC08A3_SENSOR_ID,
	SENSOR_DRVNAME_SHNBF811B_GC08A3_MIPI_RAW,
	GC08A3MIPI_RAW_SensorInit),
#endif
/*End 20211014 changshengwang  add for passat camera*/
    {0, {0}, NULL},
};
// end new camera driver fromwark with tct
//#################################################
#else
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR] = {
// begin modified by tct-hq/yzheng4 in 2022-11-25
#if defined(LUNA84GVZW_HI846_MIPI_RAW)
    {LUNA84GVZW_HI846_SENSOR_ID, SENSOR_DRVNAME_LUNA84GVZW_HI846_MIPI_RAW, LUNA84GVZW_HI846_MIPI_RAW_SensorInit},
#endif
#if defined(LUNA84GVZW_GC05A2_MIPI_RAW)
    {LUNA84GVZW_GC05A2_SENSOR_ID, SENSOR_DRVNAME_LUNA84GVZW_GC05A2_MIPI_RAW, LUNA84GVZW_GC05A2_MIPI_RAW_SensorInit},
#endif
#if defined(LUNA84GVZW_GC08A3_MIPI_RAW)
    {LUNA84GVZW_GC08A3_SENSOR_ID, SENSOR_DRVNAME_LUNA84GVZW_GC08A3_MIPI_RAW, LUNA84GVZW_GC08A3_MIPI_RAW_SensorInit},
#endif
#if defined(LUNA84GVZW_HI556_MIPI_RAW)
    {LUNA84GVZW_HI556_SENSOR_ID, SENSOR_DRVNAME_LUNA84GVZW_HI556_MIPI_RAW, LUNA84GVZW_HI556_MIPI_RAW_SensorInit},
#endif
// end modified by tct-hq/yzheng4 in 2022-11-25

/*begin 20210719 ljt add for jettatf camera*/
#if defined(TSPPHCP1088_HI1336_MIPI_RAW)
	{TSPPHCP1088_HI1336_SENSOR_ID,
	SENSOR_DRVNAME_TSPPHCP1088_HI1336_MIPI_RAW,
	HI1336_MIPI_RAW_SensorInit},
#endif
#if defined(TSPPSNP1082_S5KJN1_MIPI_RAW)
	{TSPPSNP1082_S5KJN1_SENSOR_ID, 
	SENSOR_DRVNAME_TSPPSNP1082_S5KJN1_MIPI_RAW, 
	S5KJN1_MIPI_RAW_SensorInit},
#endif
/*Begin zihao.li for [Task][11621559] AustinTF bring up camera on 20211021*/
#if defined(TSPPSNP1269_S5KJN1_MIPI_RAW)
	{TSPPSNP1269_S5KJN1_SENSOR_ID,
	SENSOR_DRVNAME_TSPPSNP1269_S5KJN1_MIPI_RAW,
	TSPPSNP1269_S5KJN1_MIPI_RAW_SensorInit},
#endif
#if defined(TSPSCF0002_S5K3L6_MIPI_RAW)
	{TSPSCF0002_S5K3L6_SENSOR_ID,
	SENSOR_DRVNAME_TSPSCF0002_S5K3L6_MIPI_RAW,
	TSPSCF0002_S5K3L6_MIPI_RAW_SensorInit},
#endif
#if defined(SHNAF538M_GC5035_MIPI_RAW )
	{SHNAF538M_GC5035_SENSOR_ID,
	SENSOR_DRVNAME_SHNAF538M_GC5035_MIPI_RAW,
	SHNAF538M_GC5035_MIPI_RAW_SensorInit},
#endif
...
//#Begin modified by chengyixuan for CIVIC-3005 on 2022-07-12
	...
	{GDIR220061_HI1336_SENSOR_ID,
	SENSOR_DRVNAME_GDIR220061_HI1336_MIPI_RAW,
	HI1336_MIPI_RAW_SensorInit},
#endif
#if defined(SWLU7166_GC13A0_MIPI_RAW)
	{SWLU7166_GC13A0_SENSOR_ID,
	SENSOR_DRVNAME_SWLU7166_GC13A0_MIPI_RAW,
	SWLU7166_GC13A0_MIPI_RAW_SensorInit},
#endif
#if defined(GKQR220088_HI5021Q_MIPI_RAW)
	{GKQR220088_HI5021Q_SENSOR_ID,
	SENSOR_DRVNAME_GKQR220088_HI5021Q_MIPI_RAW,
	HI5021Q_MIPI_RAW_SensorInit},
#endif
#if defined(GKQR220088_HI5021QMAC_MIPI_RAW)
	{GKQR220088_HI5021QMAC_SENSOR_ID,
	SENSOR_DRVNAME_GKQR220088_HI5021QMAC_MIPI_RAW,
	HI5021QMAC_MIPI_RAW_SensorInit},
#endif
#if defined(CTXVM15797_GC5035_MIPI_RAW)
    {CTXVM15797_GC5035_SENSOR_ID,
	SENSOR_DRVNAME_CTXVM15797_GC5035_MIPI_RAW,
	GC5035MIPI_RAW_SensorInit},
#endif
#if defined(LHVM15798_GC05A2_MIPI_RAW)
    {LHVM15798_GC05A2_SENSOR_ID,
	SENSOR_DRVNAME_LHVM15798_GC05A2_MIPI_RAW,
	GC05A2_MIPI_RAW_SensorInit},
#endif
#if defined(CTXVC12800_GC02M1_MIPI_RAW)
	{CTXVC12800_GC02M1_SENSOR_ID,
	SENSOR_DRVNAME_CTXVC12800_GC02M1_MIPI_RAW,
	GC02M1_MIPI_RAW_SensorInit},
#endif
#if defined(CTXVC12800P_GC02M1_MIPI_RAW)
	{CTXVC12800P_GC02M1_SENSOR_ID,
	SENSOR_DRVNAME_CTXVC12800P_GC02M1_MIPI_RAW,
	GC02M1_MIPI_RAW_SensorInit},
#endif
//#Begin modified by chengyixuan for CIVIC-3005 on 2022-07-12
/*Begin majinrui for [Task: 11669645 ] AustinTF bring up the second camera on 20211112*/
#if defined(SHNBMD28B_OV13B10_MIPI_RAW)
	{SHNBMD28B_OV13B10_SENSOR_ID,
	SENSOR_DRVNAME_SHNBMD28B_OV13B10_MIPI_RAW,
	SHNBMD28B_OV13B10_MIPI_RAW_SensorInit},
#endif
/*End majinrui for [Task: 11669645 ] AustinTF bring up the second camera on 20211112*/

#if defined(SHNBA815M_GC08A3_MIPI_RAW)
	{SHNBA815M_GC08A3_SENSOR_ID,
	SENSOR_DRVNAME_SHNBA815M_GC08A3_MIPI_RAW,
	GC08A3_MIPI_RAW_SensorInit},
#endif
#if defined(TSPPH8A1327_HI846_MIPI_RAW)
	{TSPPH8A1327_HI846_SENSOR_ID,
	SENSOR_DRVNAME_TSPPH8A1327_HI846_MIPI_RAW,
	HI846_MIPI_RAW_SensorInit},
#endif
#if defined(TSPPH8A1408_HI846_MIPI_RAW)
	{TSPPH8A1408_HI846_SENSOR_ID,
	SENSOR_DRVNAME_TSPPH8A1408_HI846_MIPI_RAW,
	HI846NEW_MIPI_RAW_SensorInit},
#endif
#if defined(TCL0003BA_GC08A3_MIPI_RAW)
	{TCL0003BA_GC08A3_SENSOR_ID,
	SENSOR_DRVNAME_TCL0003BA_GC08A3_MIPI_RAW,
	GC08A3MIPI_RAW_SensorInit},
#endif
#if defined(TSPS8F9074_S5K4H7_MIPI_RAW)
	{TSPS8F9074_S5K4H7_SENSOR_ID,
	SENSOR_DRVNAME_TSPS8F9074_S5K4H7_MIPI_RAW,
	S5K4H7_MIPI_RAW_SensorInit},
#endif
#if defined(SHNBAD17B_OV13B10_MIPI_RAW)
	{SHNBAD17B_OV13B10_SENSOR_ID,
	SENSOR_DRVNAME_SHNBAD17B_OV13B10_MIPI_RAW,
	SHNBAD17B_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(SHNBF821B_GC08A3_MIPI_RAW)
	{SHNBF821B_GC08A3_SENSOR_ID,
	SENSOR_DRVNAME_SHNBF821B_GC08A3_MIPI_RAW,
	SHNBF821B_GC08A3_MIPI_RAW_SensorInit},
#endif
#if defined(SHN9F511B_GC5035_MIPI_RAW)
	{SHN9F511B_GC5035_SENSOR_ID,
	SENSOR_DRVNAME_SHN9F511B_GC5035_MIPI_RAW,
	GC5035MIPI_RAW_SensorInit},
#endif
#if defined(TSPPS5F2052_S5K5E9_MIPI_RAW)
	{TSPPS5F2052_S5K5E9_SENSOR_ID,
	SENSOR_DRVNAME_TSPPS5F2052_S5K5E9_MIPI_RAW,
	S5K5E9_MIPI_RAW_SensorInit},
#endif
#if defined(EWYPC5319_HI556_MIPI_RAW)
	{EWYPC5319_HI556_SENSOR_ID,
	SENSOR_DRVNAME_EWYPC5319_HI556_MIPI_RAW,
	HI556_MIPI_RAW_SensorInit},
#endif
#if defined(CXTVC12499_GC02M1B_MIPI_RAW)
	{CXTVC12499_GC02M1B_SENSOR_ID,
	SENSOR_DRVNAME_CXTVC12499_GC02M1B_MIPI_RAW,
	GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(CXTVC12511_GC2905_MIPI_RAW)
	{CXTVC12511_GC2905_SENSOR_ID,
     SENSOR_DRVNAME_CXTVC12511_GC2905_MIPI_RAW,
     GC2905_MIPI_RAW_SensorInit},
#endif
#if defined(CXTVC12742_GC02M1B_MIPI_RAW)
	{CXTVC12742_GC02M1B_SENSOR_ID,
     SENSOR_DRVNAME_CXTVC12742_GC02M1B_MIPI_RAW,
     CXTVC12742_GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(SHNBF204C_GC02M1_MIPI_RAW)
	{SHNBF204C_GC02M1_SENSOR_ID,
	SENSOR_DRVNAME_SHNBF204C_GC02M1_MIPI_RAW,
	GC02M1_MIPI_RAW_SensorInit},
#endif
#if defined(SHNDS41092_OV13B10_MIPI_RAW)
	{SHNDS41092_OV13B10_SENSOR_ID,
	SENSOR_DRVNAME_SHNDS41092_OV13B10_MIPI_RAW,
	OV13B10_MIPI_RAW_SensorInit},
#endif
/*End   liuhui add for cruze_lite_tf camera porting*/
/*Start junyiliu add for cruze_Pro62 2nd porting 20211202*/
#if defined(SHNBF811B_GC08A3_MIPI_RAW)
	{SHNBF811B_GC08A3_SENSOR_ID,
	SENSOR_DRVNAME_SHNBF811B_GC08A3_MIPI_RAW,
	GC08A3MIPI_RAW_SensorInit},
#endif
...
//add by lihao.zhu for applo84gboost_refresh
        ...
        {R_CXT_GC5035_SENSOR_ID,       //0x5035+4
        SENSOR_DRVNAME_R_CXT_GC5035_MIPI_RAW,
        REAR_CXT_GC5035MIPI_RAW_SensorInit},
#endif
#if defined(R_SHINETECH_GC5035_MIPI_RAW)
	{R_SHINETECH_GC5035_SENSOR_ID,  //0x5035+2
	SENSOR_DRVNAME_R_SHINETECH_GC5035_MIPI_RAW ,
	REAR_SHINETECH_GC5035MIPI_RAW_SensorInit},
#endif
#if defined(F_SHINETECH_GC5035_MIPI_RAW)
	{F_SHINETECH_GC5035_SENSOR_ID,  //0x5035+3
	SENSOR_DRVNAME_F_SHINETECH_GC5035_MIPI_RAW ,
	FRONT_SHINETECH_GC5035MIPI_RAW_SensorInit},
#endif

#if defined(R_EWELLY_HI556_MIPI_RAW)
	{R_EWELLY_HI556_SENSOR_ID, //0x556+2
	SENSOR_DRVNAME_R_EWELLY_HI556_MIPI_RAW ,
	REAR_EWELLY_HI556MIPI_RAW_SensorInit},
#endif

#if defined(F_EWELLY_HI556_MIPI_RAW)
	{F_EWELLY_HI556_SENSOR_ID, //0x556+3
	SENSOR_DRVNAME_F_EWELLY_HI556_MIPI_RAW ,
	FRONT_EWELLY_HI556MIPI_RAW_SensorInit},
#endif
        ...
        {F_SHINETECH_OV5670_SENSOR_ID, //0x5670+2
        SENSOR_DRVNAME_F_SHINETECH_OV5670_MIPI_RAW,
        FRONT_SHINETECH_OV5670MIPI_RAW_SensorInit},
#endif
//add by lihao.zhu for applo84gboost_refresh
