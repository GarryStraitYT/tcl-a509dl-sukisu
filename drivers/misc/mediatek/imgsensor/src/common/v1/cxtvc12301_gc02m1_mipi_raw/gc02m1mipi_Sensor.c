...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = CXTVC12301_GC02M1_SENSOR_ID,
	.checksum_value =  0xf7375923,//0x5622f670,
	.pre = {
		.pclk = 84000000,
		.linelength = 2192,
		.framelength = 1276,
...
/*Begin added by xiaoming-zhong for [Task][11669054][change macau pro sensor info] on 2021/11/11*/
extern char CamNameF_module_name[256];
extern char CamOTPF_module_name[256];
/*End added by xiaoming-zhong for [Task][11669054][change macau pro sensor info] on 2021/11/11*/
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				/*Begin added by xiaoming-zhong for [Task][11669054][change macau pro sensor info] on 2021/11/11*/
				sprintf(CamNameF_module_name, "GC02M1:CXT:2M_FF:ASA2001216C1");
				/*End added by xiaoming-zhong for [Task][11669054][change macau pro sensor info] on 2021/11/11*/
...
UINT32 CXTVC12301_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
