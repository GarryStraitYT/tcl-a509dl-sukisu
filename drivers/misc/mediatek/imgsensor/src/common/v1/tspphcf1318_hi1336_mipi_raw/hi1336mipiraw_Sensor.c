...
extern bool _read_hi1336_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = TSPPHCF1318_HI1336_SENSOR_ID,
...
static void sensor_init(void)
{
    ...
    hi1336_table_write_cmos_sensor(
        ...
        sizeof(addr_data_pair_init_hi1336) / sizeof(kal_uint16));
#else
...
static void preview_setting(void)
{
    ...
    hi1336_table_write_cmos_sensor(
        ...
        sizeof(addr_data_pair_preview_hi1336) / sizeof(kal_uint16));
#else
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    if(currefps == 300) {
        hi1336_table_write_cmos_sensor(
            ...
            sizeof(addr_data_pair_capture_30fps_hi1336) / sizeof(kal_uint16));

    } else {
        hi1336_table_write_cmos_sensor(
            addr_data_pair_capture_15fps_hi1336,
            sizeof(addr_data_pair_capture_15fps_hi1336) / sizeof(kal_uint16));
    }
#else
    if(currefps == 300) {
        write_cmos_sensor(0x3250, 0xa060);  //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
static void normal_video_setting(void)
{
    ...
    hi1336_table_write_cmos_sensor(
        ...
        sizeof(addr_data_pair_video_hi1336) / sizeof(kal_uint16));
#else
    write_cmos_sensor(0x3250, 0xa060);  //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
    write_cmos_sensor(0x0730, 0x770f);  //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1)
    write_cmos_sensor(0x0732, 0xe0b0);  //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1)
...
static void hs_video_setting(void)
{
    ...
    hi1336_table_write_cmos_sensor(
        ...
        sizeof(addr_data_pair_hs_video_hi1336) / sizeof(kal_uint16));
#else
...
static void slim_video_setting(void)
{
    ...
    hi1336_table_write_cmos_sensor(
        ...
        sizeof(addr_data_pair_slim_video_hi1336) / sizeof(kal_uint16));
#else
    write_cmos_sensor(0x3250, 0xa060);  //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
    write_cmos_sensor(0x0730, 0x770f);  //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1)
...
//begin 20210513 liujunting add dor dualcam
...
//end 20210513 liujunting add dor dualcam
    ...
    UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    switch(feature_id) {
        ...
        case SENSOR_FEATURE_GET_PDAF_DATA:
            ...
            _read_hi1336_eeprom((kal_uint16)(*feature_data),
                                (char *) (uintptr_t)(*(feature_data + 1)),
                                (kal_uint32)(*(feature_data + 2)));
