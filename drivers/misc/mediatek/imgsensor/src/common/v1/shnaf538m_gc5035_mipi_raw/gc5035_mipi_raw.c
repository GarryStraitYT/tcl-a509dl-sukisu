...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SHNAF538M_GC5035_SENSOR_ID, /*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint32 get_resolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *sensor_resolution)
{
    ...
    sensor_resolution->SensorVideoWidth = imgsensor_info.cap.grabwindow_width;
    sensor_resolution->SensorVideoHeight = imgsensor_info.cap.grabwindow_height;
                           ...
                           MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->VideoDelayFrame = imgsensor_info.cap_delay_frame;
