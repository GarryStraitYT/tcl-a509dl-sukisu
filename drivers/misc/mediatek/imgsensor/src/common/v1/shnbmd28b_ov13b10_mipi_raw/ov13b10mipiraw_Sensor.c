...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SHNBMD28B_OV13B10_SENSOR_ID,
	...
	.ihdr_support = 0,
	.ihdr_le_firstline = 0,
	.sensor_mode_num = 10, //support sensor mode num ,don't support Slow motion\r
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{4224, 3136,  0,  0,  4224, 3136, 2112, 1568, 412, 424, 1280,  720, 0, 0, 1280,  720},
	{4224, 3136,  0,  0,  4224, 3136, 2112, 1568, 412, 424, 1280,  720, 0, 0, 1280,  720},
};
...
extern bool check_ov13b10_otp(void);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = return_sensor_id()+1;
		printk("bo_liu, ov13b10 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
	if (*sensor_id == imgsensor_info.sensor_id) {
		cam_pr_debug("i2c write id: 0x%x, sensor id: 0x%x\n",
			imgsensor.i2c_write_id, *sensor_id);
		sprintf(CamNameF_module_name,"OV13B10:TSP:13M_AF");
#ifdef TARGET_BUILD_MMITEST	
		if (check_ov13b10_otp())
		{
...
UINT32 SHNBMD28B_OV13B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
