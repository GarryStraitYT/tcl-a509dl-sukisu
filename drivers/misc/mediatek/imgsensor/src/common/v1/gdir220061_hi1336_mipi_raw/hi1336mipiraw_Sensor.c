...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = GDIR220061_HI1336_SENSOR_ID,
	
	.checksum_value = 0x64d140c4,       //0x6d01485c // Auto Test Mode ����..
	.pre = {
		.pclk = 598000000,				//record different mode's pclk
		.linelength =  6004, 			//record different mode's linelength
		.framelength = 3318, 			//record different mode's framelength
		...
		.max_framerate = 300,	
		.mipi_pixel_rate = 296400000, //(741M*4/10)
	},
	.cap = {
		.pclk = 598000000,
		.linelength = 6004, 	
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 592800000, //(1482M * 4 / 10 )
	},
	// need to setting
    .cap1 = {                            
		.pclk = 598000000,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 572000000,//(1430M*4/10)
    },
	.normal_video = {
		.pclk = 598000000,
		.linelength = 6004, 	
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 572000000, //( 1428M*4/10)
	},
	.hs_video = {
        .pclk = 600000000,
        .linelength = 6004,				
...
extern void sr_add_camera_main_ic_name(char *name);
#endif
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		#ifdef CONFIG_SR_HARDWARE_INFOMATION
			sr_add_camera_main_ic_name("HI1336MIPI_13M_GZ");
		#endif
			if(check_hi1336_otp())
			{
