...
//////////////////////////////////////////////////////////
#define S5K5E9_MODULEINFO_FLAG (0x0001)
#define S5K5E9_MODULEINFO_VALUE (0x0002)
#define S5K5E9_MODULEINFO_CHKSUM (0x0004)

#define S5K5E9_AWB_FLAG (0x0008)
#define S5K5E9_AWB_CHKSUM (0x0010)

#define S5K5E9_LSC_FLAG (0x0002)
#define S5K5E9_LSC_CHKSUM (0x0040)

// otp flag addr
#define S5K5E9_MODULE_INFO_FLAG 0x0A04
#define S5K5E9_AWB_INFO_FLAG 0x0A19
#define S5K5E9_LSC_INFO_FLAG 0x0A3D

#define S5K5E9_LSC_INFO_START 0x0A04

#define S5K5E9_MDINFO_PAGE 0x11
#define S5K5E9_AWB_PAGE 0x11
#define S5K5E9_LSC_PAGE 0x00

#define S5K5E9_MODULE_LENGTH 10
#define S5K5E9_AWB_LENGTH 18
#define S5K5E9_LSC_LENGTH 40

typedef struct moduleInfo_struct
{
	kal_uint8 moduleID;
	kal_uint8 Year;
	kal_uint8 Month;
