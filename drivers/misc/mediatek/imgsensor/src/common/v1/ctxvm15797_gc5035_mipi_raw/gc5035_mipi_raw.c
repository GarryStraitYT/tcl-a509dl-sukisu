...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = CTXVM15797_GC5035_SENSOR_ID, /*record sensor id defined in Kd_imgsensor.h*/
...
static kal_uint8 gc5035_otp_identify(void)
{
    ...
    if((module_info.module_id == 0x01) && (module_info.lens_id == 0x01) && (module_otp_flag == 1) && (wb_otp_flag == 1) && (wb_golden_otp_flag == 1)) {
...
#endif
 extern CamNameF_module_name[256];
 extern CamOTPF_module_name[256];
        ...
        do {
            *sensor_id = return_sensor_id();
            if(*sensor_id == imgsensor_info.sensor_id) {
                gc5035_otp_identify();
                LOG_INF("cyxget_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
                        imgsensor.i2c_write_id, *sensor_id);
	#ifdef CONFIG_SR_HARDWARE_INFOMATION
		sr_add_camera_sub_ic_name("GC5035MIPI_5M_CXT");
	#endif
                               return ERROR_NONE;
            }
