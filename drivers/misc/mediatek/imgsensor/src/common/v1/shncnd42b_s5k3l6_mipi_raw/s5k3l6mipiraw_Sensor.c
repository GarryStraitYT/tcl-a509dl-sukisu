...
extern bool check_shncnd42b_otp(void);
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SHNCND42B_S5K3L6_SENSOR_ID,
    ...
    .cap = {
        ...
        .framelength = 3281,        //record different mode's framelength
        .startx = 0,                //record different mode's startx of grabwindow
        .starty = 0,                //record different mode's starty of grabwindow
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch(image_mirror) {
        ...
        case IMAGE_HV_MIRROR:
            //printk("image_mirror : IMAGE_HV_MIRROR, value = %d\n", (itemp | 0x03));
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001))+1;
            if(*sensor_id == imgsensor_info.sensor_id) {
                ...
                if(check_shncnd42b_otp())
                    *sensor_id |= 0x01000000;  ////add by qiangzhang 20190912
                return ERROR_NONE;
            }
                          ...
                          MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    switch(scenario_id) {
        ...
        case MSDK_SCENARIO_ID_CUSTOM1:
            ...
            break;
        case MSDK_SCENARIO_ID_CUSTOM2:
            capture(image_window, sensor_config_data);  // custom2
            break;
        default:
    ...
    switch(feature_id) {
        ...
        case SENSOR_FEATURE_GET_PIXEL_RATE:
            switch(*feature_data) {
                ...
                case MSDK_SCENARIO_ID_CUSTOM1:
                    *(MUINT32 *) (uintptr_t)(*(feature_data + 1)) =
                        (imgsensor_info.custom1.pclk / (imgsensor_info.custom1.linelength - 80)) * imgsensor_info.custom1.grabwindow_width;
