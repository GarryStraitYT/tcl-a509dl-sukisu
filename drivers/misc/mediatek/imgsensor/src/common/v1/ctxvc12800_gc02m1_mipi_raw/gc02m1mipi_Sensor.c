...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = CTXVC12800_GC02M1_SENSOR_ID,
...
extern void sr_add_camera_depth_ic_name(char *name);
#endif
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			#ifdef CONFIG_SR_HARDWARE_INFOMATION
				sr_add_camera_depth_ic_name("GC02M1MIPI_2M_CXT");
			#endif
				return ERROR_NONE;
			}
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
    ...
    "GC02M1:CXT:2M:ASA2001237C1",
    3,  ////main:0 front:1 main2:2  sub2:3  main3:4
    {
        {PDN, Vol_Low, 0},
