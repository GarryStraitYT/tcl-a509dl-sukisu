...
#include "r_cxt_gc5035_mipi_raw.h"
/************************** Modify Following Strings for Debug **************************/
#define PFX "r_gc5035_cxt_camera_sensor"
#define LOG_1 LOG_INF("GC5035MIPI, 2LANE\n")
/****************************   Modify end    *******************************************/
#define GC5035_CXT_DEBUG 1
#if GC5035_CXT_DEBUG
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = R_CXT_GC5035_SENSOR_ID, /*record sensor id defined in Kd_imgsensor.h*/
    ...
    .i2c_addr_table = {0x6e, 0x7e, 0x5e, 0xff},
};
...
static kal_uint8 gc5035_otp_identify(void)
{
    ...
    write_cmos_sensor(0xfe, 0x00);
    write_cmos_sensor(0xfa, 0x00);
    LOG_INF(" module_info.module_id = 0x%x, module_info.lens_id = 0x%x, module_otp_flag = %d, wb_otp_flag = %d, wb_golden_otp_flag = %d\n", module_info.module_id, module_info.lens_id, module_otp_flag, wb_otp_flag, wb_golden_otp_flag);
    if((module_info.module_id == 0x47) && (module_info.lens_id == 0xe3) && (module_otp_flag == 1) && (wb_otp_flag == 1) && (wb_golden_otp_flag == 1)) {
        LOG_INF("GC5035A_OTP_Flag = 1\n");
        GC5035A_OTP_Flag = 1;
    } else {
        LOG_INF("GC5035A_OTP_Flag = 0\n");
        GC5035A_OTP_Flag = 0;
    }
    return moduleID;
}
