...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct cap2;			//capture for PIP 15fps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
...
extern bool check_tsppsnp1269_s5kjn1_otp(void);
extern BYTE get_tsppsnp1269_s5kjn1_lensID(void);
#endif
