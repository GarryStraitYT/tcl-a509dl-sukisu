...
#define PFX "luna84gvzw_hi556_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = LUNA84GVZW_HI556_SENSOR_ID,
...
{
    LOG_INF("image_mirror 11 = %d", image_mirror);
...
static void read_hi556_otp(void)
{
    ...
    int year = 0, month = 0, day = 0, sensor_id = 0;
    int lens_id = 0, vcm_id = 0, vcm_ic_id = 0, f_num = 0;
    ...
    /*****************************modify/add history******************************/
    /*begin on 20220610 jinruima modify for hi556 OTP check*/
    mdelay(10);
...
//      gGbGr = golden_Gb * 1024 / golden_Gr;;
        ...
        RGr = (data_awb[0] << 8) | (data_awb[1] & 0xff);
        BGb = (data_awb[2] << 8) | (data_awb[3] & 0xff);
        GbGr = (data_awb[4] << 8) | (data_awb[5] & 0xff);
        gRGr = (data_awb[6] << 8) | (data_awb[7] & 0xff);
        gBGb = (data_awb[8] << 8) | (data_awb[9] & 0xff);
        gGbGr = (data_awb[10] << 8) | (data_awb[11] & 0xff);

        check_sum_awb = data_awb[29];
        check_sum_awb_cal = (check_sum_awb_cal % 255) + 1;
    }
    /* End on 20220610 jinruima modify for hi556 OTP check*/
    ...
    if ((otp_flag != 0) && (awb_flag != 0) && (module_id == 0x52) && (lens_id == 0xc2) && (check_sum == check_sum_cal) && (check_sum_awb == check_sum_awb_cal)) {
        hi556_otp_flag = 1;
    } else {
        hi556_otp_flag = 0;
    }
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                strcpy(CamNameF_module_name, "HI556:GLOBALOPTICS:5M:ASA5001266C1");
    ...
    UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO:
        ...
        case MSDK_SCENARIO_ID_SLIM_VIDEO:
            *(MUINT32 *)(uintptr_t)(*(feature_data + 1))
            ...
            break;
        //+bug 558061, , modify, 2020/07/23, modify codes for main camera hw remosaic
    ...
    case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
        ...
        break;
    // begin modified by tct-hq/yzheng4 in 2022-08-12
    // fix bug; if get pixel rate return zero, cst would failed
    case SENSOR_FEATURE_GET_PIXEL_RATE:
        ...
        break;
    // end modified by tct-hq/yzheng4 in 2022-08-12
