...
static struct LCM_setting_table  lcm_initialization_setting_ty[] = {
	{0xee,1, {0x50}},				// ENTER PAGE1
	{0xea,2, {0x85,0x55}},			// write enable
	{0x24,1, {0xa0}},				// rgb  TE
	{0x30,1, {0x00}},				// bist=1 auto run
	{0x7a,1, {0x20}},   
	{0x7d,1, {0x00}},
	...
	{0x33,1, {0xc3}},
	{0x34,1, {0x2f}},
	{0x3a,1, {0x24}},				// gas value  
	{0x3b,1, {0x00}},				// gip s2s-s3s
	//(0x3c,0x60}},			// vcom set
	{0x3d,2, {0x02,0x82}},			// vgl/vgh   
	{0x42,2, {0x64,0x64}},			// vspr ,vsnr  
	{0x44,1, {0x08}},				// VGH  14.98v
	{0x46,1, {0xD4}},				// VGL  -11v
	{0x86,1, {0x10}},
	//{0x89,1, {0x45}},//zhangbing add
	{0x8d,1, {0x00}},
	{0x91,1, {0x44}},				// frq_vgh_clk frq_vgl_clk/
	{0x9a,1, {0x05}},				// 720     
	{0x9b,2, {0x02,0xd0}},				//1280 
	
	//Gamma2.2-2021/08/04 
	{0x47,5, {0x05,0x26,0x32,0x41,0x41}},		//gamma p 0.4.8.12.20
	{0x5a,5, {0x05,0x26,0x32,0x41,0x41}},		//gamma n 0.4.8.12.20

	{0x4c,5, {0x50,0x4c,0x5d,0x3e,0x3d}},		//28.44.64.96.128.
	{0x5f,5, {0x50,0x4c,0x5d,0x3e,0x3d}},		//28.44.64.96.128. 

	{0x51,5, {0x3d,0x22,0x36,0x32,0x3e}},		//159.191.211.227.235
	{0x64,5, {0x3d,0x22,0x36,0x32,0x3e}},		//159.191.211.227.235 

	{0x56,4, {0x42,0x4d,0x59,0x7f}},			//243.247.251.255
	{0x69,4, {0x42,0x4d,0x59,0x7f}},			//243.247.251.255

	{0xee,1, {0x70}},
	// STV0   stv1
	{0x00,5, {0x04,0x07,0x00,0x01,0xa8}},
	{0x05,5, {0xab,0x55,0x01,0x00,0x00}},  
	{0x0a,5, {0x00,0x00,0x05,0x55,0x00}},
	//gip-cyc0
	{0x10,5, {0x06,0x09,0x00,0x01,0x00}},
	{0x15,5, {0x00,0xa6,0x0d,0x08,0x00}},
	{0x29,2, {0x05,0x55}},

	{0x30,5, {0xb9,0xb9,0x55,0x5d,0x5d}},
	{0x35,5, {0x3c,0xb9,0xb9,0x55,0x3d}},
	{0x3a,2, {0x3d,0x3c}}, 
	
	// forward scan
	{0x60,5, {0x3f,0x3c,0x20,0x21,0x10}},  
	{0x65,5, {0x12,0x14,0x16,0x00,0x3c}},  
	{0x6a,5, {0x3c,0x3c,0x3c,0x3c,0x3c}},
	{0x6f,5, {0x04,0x3c,0x3c,0x3c,0x3c}},
	{0x74,2, {0x3c,0x3c}},

	{0x80,5, {0x3f,0x3c,0x20,0x21,0x11}},  
	{0x85,5, {0x13,0x15,0x17,0x01,0x3c}},  
	{0x8a,5, {0x3c,0x3c,0x3c,0x3c,0x3c}},  
	{0x8f,5, {0x05,0x3c,0x3c,0x3c,0x3c}},
	{0x94,2, {0x3c,0x3c}},
...
struct LCM_DRIVER rapidtf_tdt_gh1001_hd_dsi_vdo_lcm_drv =
{
    .name           = "rapidtf_tdt_gh1001_hd_dsi_vdo",
