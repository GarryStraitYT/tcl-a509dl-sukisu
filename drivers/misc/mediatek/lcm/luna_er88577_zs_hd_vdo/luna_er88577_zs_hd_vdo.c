...
static struct LCM_setting_table  lcm_initialization_setting_ty[] = {
    ...
    {0xB9,38,{0x7F,0x6A,0x59,0x4C,0x45,0x36,0x3C,0x25,0x41,0x40,
    		 0x41,0x5B,0x46,0x4D,0x3F,0x3D,0x31,0x23,0x26,0x7F,
    		 0x6A,0x59,0x4C,0x45,0x36,0x3C,0x25,0x41,0x40,0x41,
    		 0x5B,0x46,0x4D,0x3F,0x3D,0x31,0x23,0x26}},//20 后面06改为26优化残影效果
    ...
    {0xF3,1,{0x00}},
        ...
        // Sleep Mode On
    {0x11,1,{0x00}},
    {REGFLAG_DELAY_MS_V3,130,{0x00}},
    {0x29,1,{0x00}},
    {REGFLAG_DELAY_MS_V3,30,{0x00}},
...
struct LCM_DRIVER luna_er88577_zs_hd_vdo_lcm_drv = {
	.name = "luna_er88577_zs_hd_vdo",
