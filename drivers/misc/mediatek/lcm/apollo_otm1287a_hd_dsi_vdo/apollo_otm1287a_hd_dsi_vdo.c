...
//end add by xiongbo.huang.
    ...
    //begin add by jiaxin.pi for AGBR-3613 on 20211217
    params->dsi.lcm_esd_check_table[0].para_list[0] = 0x1c;
    //end add by jiaxin.pi for AGBR-3613 on 20211217
...
/*#ifdef CONFIG_TCT_APOLLO
    ...
    cmd=0x00;
    data=0x11; //add by jiaxin.pi fix vsp 5.7v for 11338165
    ...
    MDELAY(3);
    SET_RESET_PIN(1);
    MDELAY(50);//need at least 50ms to have ic sent init code
...
struct LCM_DRIVER apollo_otm1287a_hd_dsi_vdo_lcm_drv =
{
    .name           = "apollo_otm1287a_hd_dsi_vdo",
