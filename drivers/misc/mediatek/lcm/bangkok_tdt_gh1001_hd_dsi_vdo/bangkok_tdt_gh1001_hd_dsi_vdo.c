...
static struct LCM_setting_table  lcm_initialization_setting_ty[] = {
	...
	{0x99,1, {0x00}},        // 
	{0x97,1, {0x37}},   //   smrt gi
	{0x24,1, {0xa0}},        // rgb  TE  if use backward scan set B0
	...
	{0x27,1, {0x62}},         // vddd  
	{0x2c,1, {0xf9}},  
	{0x30,1, {0x01}},     	//0x01:4lane ,0x00:3lane
	{0x32,1, {0xd9}},
	{0x33,1, {0xc7}},//c3
	{0x34,1, {0xff}},//2f
	//(0x3a,0x26}}, 		//GAS diasable 86
	{0x3b,1, {0x00}}, //c8->00->cd  
	//(0x3c,0x18}},		// vcom set
	{0x3d,1, {0x02}},  	//VGL
	{0x3e,1, {0x83}}, 		//VGH
	{0x44,1, {0x08}},//
	{0x46,1, {0xd4}},//
	{0x42,2, {0x64,0x64}},  //  vspr vsnr
	{0x86,1, {0x20}},		//
	{0x8c,1, {0x18}},
	{0x8d,1, {0x06}},
	{0x9a,1, {0x05}},     	// 
	{0x9b,2, {0x03,0x0c}}, 	//1560


 	//Gamma 2.2  2021/07/30
	{0x47,5, {0x10,0x23,0x30,0x3a,0x36}},  ///gamma P  0.4.8.12.20
 	{0x5a,5, {0x10,0x23,0x30,0x3a,0x36}},    //gamma n 0.4.8.12.20

	{0x4c,5, {0x41,0x38,0x48,0x27,0x23}}, //28.44.64.96.128. 
 	{0x5f,5, {0x41,0x38,0x48,0x27,0x23}}, //28.44.64.96.128. 

	{0x51,5, {0x20,0x01,0x15,0x10,0x1f}}, //159.191.211.227.235 
	{0x64,5, {0x20,0x01,0x15,0x10,0x1f}}, //159.191.211.227.235  

	{0x56,4, {0x26,0x36,0x50,0x7f}},  	  //243.247.251.255
	{0x69,4, {0x26,0x36,0x50,0x7f}},      //243.247.251.255

	{0xee,1, {0x70}},  	//enter page3
	{0x00,4, {0x02,0x06,0x00,0x01}},
	{0x04,4, {0x1e,0x22,0x66,0x01}},  
	{0x0c,2, {0x65,0x65}},
	//gip-c0
 	{0x10,5, {0x05,0x08,0x00,0x00,0x00}},
 	{0x15,5, {0x00,0x21,0x0e,0x08,0x00}},
 	{0x29,2, {0x65,0x65}},
	
     //  FORWARD SCAN
	{0x60,5, {0x3c,0x3c,0x3c,0x07,0x05}},
 	{0x65,5, {0x17,0x15,0x13,0x11,0x3c}},
	{0x6a,5, {0x3c,0x3c,0x3c,0x3c,0x3c}},
	{0x6f,5, {0x3c,0x3c,0x3c,0x01,0x03}},
	{0x74,2, {0x3c,0x3c}},

	{0x80,5, {0x3c,0x3c,0x3c,0x06,0x04}},
 	{0x85,5, {0x16,0x14,0x12,0x10,0x3c}},
	...
	{0x94,2, {0x3c,0x3c}},
     ...
     /*
     // backward scan
	(0x60,0x3c,0x3c,0x3c,0x00,0x02}},   
 	(0x65,0x14,0x16,0x10,0x12,0x3c}},  
	(0x6a,0x3c,0x3c,0x3c,0x3c,0x3c}},  
	(0x6f,0x3c,0x3c,0x3c,0x06,0x04}},
	(0x74,0x3c,0x3c}},

	(0x80,0x3c,0x3c,0x3c,0x01,0x03}},  
 	(0x85,0x15,0x17,0x11,0x13,0x3c}},  
	(0x8a,0x3c,0x3c,0x3c,0x3c,0x3c}},  
	(0x8f,0x3c,0x3c,0x3c,0x07,0x05}},
	(0x94,0x3c,0x3c}},
     */
	{0xea,2, {0x00,0x00}}, 
...
#if 1
	params->dsi.lcm_esd_check_table[0].cmd          = 0x00;
...
struct LCM_DRIVER bangkok_tdt_gh1001_hd_dsi_vdo_lcm_drv =
{
    .name           = "bangkok_tdt_gh1001_hd_dsi_vdo",
