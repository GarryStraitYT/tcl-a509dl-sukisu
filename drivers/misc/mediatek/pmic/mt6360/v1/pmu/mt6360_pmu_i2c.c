...
static const struct mt6360_pmu_platform_data def_platform_data = {
	.irq_gpio = -1,
//Begin modify by qiuguangliang for task-11172723 on 2021-06-08
#if ((!defined TARGET_BUILD_GCF) && (!defined TARGET_BUILD_CERTIFICATION) && (!defined TARGET_BUILD_MMITEST))
	.disable_lpsd = false,
#else
	.disable_lpsd = true,
#endif
//End modify by qiuguangliang for task-11172723 on 2021-06-08
};
