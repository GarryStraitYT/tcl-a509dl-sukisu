...
#define AF_DRVNAME "DW9718SAF2ND_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd3[2] = {0x03, 0x64}; /* Move 210 Code */

		char puSendCmd4[2] = {0x01, 0x39}; /* sac3 Mode */
		char puSendCmd5[2] = {0x05, 0x7F}; /* SAC period Setting */
...
/* ////////////////////////////////////////////////////////////// */
long DW9718SAF2ND_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9718SAF2ND_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	/* power down mode */
...
int DW9718SAF2ND_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9718SAF2ND_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9718SAF2ND_GetFileName(unsigned char *pFileName)
{
