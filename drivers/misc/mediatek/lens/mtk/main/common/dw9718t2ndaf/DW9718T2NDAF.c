...
#define AF_DRVNAME "DW9718T2NDAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DW9718T2NDAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9718T2NDAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9718T2NDAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9718T2NDAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9718T2NDAF_GetFileName(unsigned char *pFileName)
{
