...
#define AF_DRVNAME "DW9800WAFMAC_DRV"
...
static int AFPowerDownFlag = 0;
static int i2cReturnCode = 0;
...
static int s4DW9800WAFMAC_ReadReg(unsigned short *a_pu2Result)
{
...
int W9800WAFMAC_PowerDown(struct i2c_client *pstAF_I2Cclient, int *pAF_Opened)
{
...
static int initdrv(void)
{
	...
	{0x02, 0x01}, {0x02, 0x00}, {0xFE, 0xFE},{0x10, 0x01},{0x02, 0x02},
	{0x06, 0x40}, {0x07, 0x64}, {0xFE, 0xFE},
	};
...
/* ////////////////////////////////////////////////////////////// */
long DW9800WAFMAC_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800WAFMAC_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	unsigned char uc_num;
	int i4RetValue =0;
	...
	//LOG_INF("AFPowerDownFlag %d\n",AFPowerDownFlag);
	LOG_INF("i2cReturnCode %d\n",i2cReturnCode);
    LOG_INF("close\n");
	LOG_INF("End\n");
...
int DW9800WAFMAC_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
	...
	if (*g_pAF_Opened == 1) {
		initdrv();
		ret = s4DW9800WAFMAC_ReadReg(&InitPos);
...
int DW9800WAFMAC_GetFileName(unsigned char *pFileName)
{
