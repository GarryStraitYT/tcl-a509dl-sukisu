...
char modem_build_ver[64]={0};
int md_ccci_lasterrcode=0;
#endif
...
#ifdef CONFIG_HELAEYE_BSP_MODEMCRASH_ON
	strcpy(modem_build_ver,image->img_info.build_ver);
  printk("[helaeye] md_check_header_parser modem [build_ver]: %s \n",modem_build_ver);
#endif
