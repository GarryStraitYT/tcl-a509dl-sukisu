...
static int sf_ctl_report_key_event(struct input_dev *input, sf_key_event_t *kevent)
{
    ...
    switch (kevent->key) {
        ...
        case SF_KEY_F11:
            /* Begin Modified by qianbo.pan for 11668813 on 2021.11.11 */
            //key_code = KEY_F11;
            if (kevent->value == 0) {
                key_code = TCL_KEY_CLICK;
            ...
            /* End Modified by qianbo.pan for 11668813 on 2021.11.11 */
            break;
...
#endif
#endif
    xprintk(SF_LOG_LEVEL, "%s(..) enter. and flag is %l\n", __FUNCTION__, flags);
...
static int sf_ctl_init_input(void)
{
	...
	__set_bit(TCL_KEY_CLICK, sf_ctl_dev.input->keybit);    //Added by qianbo.pan for 11668813 on 2021.11.11
