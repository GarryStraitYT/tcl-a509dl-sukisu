...
static int fts_ts_resume(struct device *dev)
{
	...
	A5_03_FLAG = 0;
	printk("bo_liu, fts_ts_resume end, A5_03_FLAG=%d", A5_03_FLAG);
...
#else
unsigned char ctp_module_name_temp[128];
...
#if 1
#ifdef CONFIG_TCT_DEVICEINFO
	snprintf(ctp_module_name, 128, "FT8006SAA:COE:5POINT:AUC0600141C1");
#else
	snprintf(ctp_module_name_temp, 128, "FT8006SAA:COE:5POINT:AUC0600141C1");
