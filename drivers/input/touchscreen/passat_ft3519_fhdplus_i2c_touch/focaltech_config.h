...
//Begin add by jingqing.yan for common feature 2022.09.05
/*
   TCT double wakeup function
*/
#define TCT_FEATURE_TOUCH_DOUBLEWAKEUP           1
/*
   TCT charge detect function
*/
#define TCT_FEATURE_TOUCH_CHARGE                 1
/*
   TCT edge function
*/
#define TCT_FEATURE_TOUCH_EDGE          	 1

/*
   TCT palm function
*/
#define TCT_FEATURE_TOUCH_PALM		         1
/*
   TCT gamemode function
*/
#define TCT_FEATURE_TOUCH_GAMEMODE	         0

//End add by jingqing.yan for common feature 2022.09.05
 ...
 */
#define FTS_UPGRADE_FW_FILE                      "include/firmware/FT3519_ref_V0d_D01_20211222_app.i"
