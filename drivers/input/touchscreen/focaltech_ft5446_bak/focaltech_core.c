...
static int fts_power_source_init(struct fts_ts_data *ts_data)
{
    ...
    FTS_FUNC_ENTER();
    FTS_ERROR("get vtouch regulator start.");
    ...
    FTS_ERROR("get vcc_i2c regulator start.");
...
/* Begin add by lingchen for ctp info */
		...
		struct device_attribute *attr, char *buf)
{
	...
	if ((fwver == 0xFF) || (fwver == 0x00))
		...
		num_read_chars = snprintf(buf, PAGE_SIZE, "FT5446:TDT:%02x\n", fwver);
...
/* End add by lingchen for ctp info */
