...
//begin add by kun.zheng for deviceinfo task 8998289 on 2020/06/05
...
static void deviceinfo_module_name_copy(void){
        ...
        if(ret < 0){
               ...
               snprintf(ctp_module_name, 256, "FT8006S:TDT"); //PAGE_SIZE
        return;
}
//end add by kun.zheng for deviceinfo task 8998289 on 2020/06/05
