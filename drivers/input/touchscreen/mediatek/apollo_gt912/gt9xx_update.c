...
#include "gt9xx_firmware.h"//add by xiongbo.hunag
...
//begin add by xiongbo.huang to use .h firmware
static struct firmware gt9xx_firmware = {
    .data = &gt9xx_fw[0],
    .size = sizeof(gt9xx_fw),
};
//end add by xiongbo.huang to use .h firmware
u16 show_len;
u16 total_len;
u8 searching_file = 0;
u8 got_file_flag = 0;
...
//begin add by xiongbo.huang use .h firmware on20200310
#else
    if (update_msg.fw != NULL) {
        update_msg.fw = NULL;
    }
//end add by xiongbo.huang use .h firmware on20200310
#endif
...
s32 gup_fw_download_proc(void *dir, u8 dwn_mode)
{
        ...
        GTP_INFO("Request firmware...");
//begin modified by xiongbo.huang to use .h firmware
#ifdef CONFIG_GTP_REQUEST_FW_UPDATE
        GTP_INFO("Request firmware...");
        ...
        update_msg.fw = &gt9xx_firmware;
#endif
//end modfied by xiongbo.huang to use .h firmware
        GTP_INFO("Firmware size: %zd", update_msg.fw->size);
        if (update_msg.fw->size <
                (FW_HEAD_LENGTH + FW_SECTION_LENGTH * 4 +
                 FW_DSP_ISP_LENGTH + FW_DSP_LENGTH + FW_BOOT_LENGTH)) {
...
static u32 gup_clk_count_get(void)
{
        ...
        while (flag) /* Wait for measurement complete */ {
