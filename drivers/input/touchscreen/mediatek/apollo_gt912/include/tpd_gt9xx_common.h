...
//begin modified by xiognbo.haung to reduce the time that request main clk has tried
#define GTP_CHK_FS_MNT_MAX              10
//end modified by xiognbo.haung to reduce the time that request main clk has tried
