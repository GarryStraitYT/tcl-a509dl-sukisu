...
extern void cts_add_virtual_proximity(void);
extern int lcd_ic_9916;
extern int lcd_ic_9916_zgd;
static int __init chipone_tpd_driver_init(void)
{
    ...
    if(lcd_ic_9916==0 && lcd_ic_9916_zgd==0)
    {
       cts_info("chipone_tpd_driver_init exit lcd_ic_9916=%d",lcd_ic_9916 );
        return -1;
    }
...
MODULE_FIRMWARE(CFG_CTS_FIRMWARE_FILENAME_9916_ZGD);
