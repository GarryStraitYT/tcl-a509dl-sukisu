...
enum cts_device_fw_reg {
    ...
    CTS_DEVICE_FW_REG_SYSTEM_BUSY = 0x0001,	
    ...
    CTS_DEVICE_FW_REG_SCAN_MODE = 0x804E,
...
struct chipone_ts_data {
    ...
    struct proc_dir_entry *proc_gesture_state;
#endif
...
#ifdef CONFIG_CTS_GESTURE_SWITCH
extern int cts_gesture_switch_init(struct chipone_ts_data *cts_data);
extern void cts_gesture_switch_deinit(struct chipone_ts_data *cts_data);
#endif
...
#ifdef CTS_TOUCH_FACTORY_TEST
extern int  cts_factory_init(struct chipone_ts_data *cts_data);
extern void cts_factory_deinit(struct chipone_ts_data *data);
#else 
static inline int   cts_factory_init(struct chipone_ts_data *cts_data) {return 0;}
static inline void  cts_factory_deinit(struct chipone_ts_data *data) {}
#endif 
