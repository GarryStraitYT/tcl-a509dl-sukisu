...
#define MAX_SUPPORT_ID_NUM  9u
    ...
    static struct sensor_id_fs sensor_id_bin_table[] = {
        { "ICNT89xx", {
            {0x00, "/vendor/firmware/ICNT89xx_00.bin",},
            {0x01, "/vendor/firmware/ICNT89xx_01.bin",},
            {0x02, "/vendor/firmware/ICNT89xx_02.bin",},
            {0x10, "/vendor/firmware/ICNT89xx_10.bin",},
            {0x11, "/vendor/firmware/ICNT89xx_11.bin",},
            {0x12, "/vendor/firmware/ICNT89xx_12.bin",},
            {0x20, "/vendor/firmware/ICNT89xx_20.bin",},
            {0x21, "/vendor/firmware/ICNT89xx_21.bin",},
            {0x22, "/vendor/firmware/ICNT89xx_22.bin",},
            {0xff, "/vendor/firmware/ICNT89xx.bin",},
            },
        },
        { "ICNT86xx", {
    ...
    static struct bin_in_fs  bin_table[] = {
       { "ICNT89xx", "/vendor/firmware/ICNT89xx.bin",},
