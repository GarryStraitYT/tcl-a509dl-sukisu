...
static s32 tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    if (RECOVERY_BOOT == get_boot_mode())   // important
        return 0;
#endif
	printk("bo_liu, mediatek/banagkoktf_gt1151 tpd_i2c_probe start\n");
	...
	// get_cfg_version();
	printk("bo_liu, mediatek/banagkoktf_gt1151 tpd_i2c_probe done\n");
	return 0;
}
...
static int tpd_local_init(void)
{
	...
	printk("bo_liu, mediatek/banagkoktf_gt1151 tpd_local_init done\n");
	tpd_type_cap = 1;
