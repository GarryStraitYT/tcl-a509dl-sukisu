...
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN		1104
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX		3024
#define OEM_OF_DEF_PROPVAL_NOISE_FRAMES     50
#define OEM_OF_DEF_PROPVAL_NOISE_MAX        85
#define OEM_OF_DEF_PROPVAL_OPEN_MIN		900
#define OEM_OF_DEF_PROPVAL_SHORT_MIN		1500
