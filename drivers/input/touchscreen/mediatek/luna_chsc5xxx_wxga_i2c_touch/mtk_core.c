...
int semi_touch_power_enable(int en);
...
static void tct_deviceinfo_get(void)
{
    sprintf(ctp_module_name, "CHSC5448A:%s:NULL:AUE73K0A11C2", "DPT");
}
#endif
