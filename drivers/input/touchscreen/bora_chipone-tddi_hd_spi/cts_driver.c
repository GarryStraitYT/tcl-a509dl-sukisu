...
#else
extern unsigned char ctp_module_name_temp[256];
...
#ifdef CONFIG_TCT_DEVICEINFO
	snprintf(ctp_module_name, 128, "CHIPONETDDI:TDT:5POINT:AUC0600144C1");
#else
	Create_ctpinfo_node_ForMMI();
	snprintf(ctp_module_name_temp, 256, "CHIPONETDDI:TDT:5POINT:AUC0600144C1\n");
#endif
	printk("bo_liu, func:%s, line:%d\n", __func__, __LINE__);
