...
#ifdef CFG_TCL_PALM
    CTS_CMD_PALM_ATTACHED = 0x70,
    CTS_CMD_PALM_DETACHED = 0x71,
#endif
...
struct cts_dev_ops {
	...
	int (*set_freq_en)(const struct cts_device *cts_dev, u8 enable);
...
extern int cts_is_mnt_enabled(struct cts_device *cts_dev, u8 *enabled);
extern int cts_set_mnt_enable(struct cts_device *cts_dev, u8 enabled);
extern struct chipone_ts_data *tct_data;
#endif /* CTS_CORE_H */
