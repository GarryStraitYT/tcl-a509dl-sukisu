...
int cts_tcs_set_freq_en(const struct cts_device *cts_dev, u8 enable)
{
	return cts_tcs_spi_write(cts_dev, TP_STD_CMD_FREQ_HOP_EN_RW,
...
struct cts_dev_ops tcs_ops = {
	...
	.set_freq_en			= cts_tcs_set_freq_en,
