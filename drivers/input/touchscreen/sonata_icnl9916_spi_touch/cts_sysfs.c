...
struct chipone_ts_data *tct_data;
...
extern void chipone_set_charge_en(unsigned int enable);
#endif


#ifdef CFG_TCL_LANDSCAPE_MODE
extern void (*tct_grip_mode_set)(unsigned int screen_mode, unsigned int level);
extern void  chipone_grip_mode_set(unsigned int screen_mode, unsigned int level);
#endif
		...
		struct device_attribute *attr, char *buf)
{
    ...
    struct cts_test_param test_param = {
		...
		.test_data_filepath =
		    "/sdcard/rawdata/open-test-data.txt",
		.num_invalid_node = 0,
		.invalid_nodes = NULL,
    };
    int min = 0;
		...
		struct device_attribute *attr, char *buf)
{
    ...
    struct cts_test_param test_param = {
		...
		.flags = CTS_TEST_FLAG_VALIDATE_DATA |
				 ...
				 CTS_TEST_FLAG_DUMP_TEST_DATA_TO_FILE,
		.test_data_filepath =
		    "/sdcard/rawdata/short-test-data.txt",
		.num_invalid_node = 0,
		.invalid_nodes = NULL,
    };
    int min = 0;
		...
		struct device_attribute *attr, char *buf)
{
    ...
    struct cts_test_param test_param = {
		...
		.flags = CTS_TEST_FLAG_VALIDATE_DATA |
				 ...
				 CTS_TEST_FLAG_DUMP_TEST_DATA_TO_FILE,
		.test_data_filepath =
			"/sdcard/rawdata/comp-cap-test-data.txt",
		.num_invalid_node = 0,
		.invalid_nodes = NULL,
    };
    int min = 0, max = 0;
		...
		struct device_attribute *attr, char *buf)
{
    ...
    struct cts_test_param test_param = {
		...
		.flags = CTS_TEST_FLAG_VALIDATE_DATA |
				 ...
				 CTS_TEST_FLAG_DUMP_TEST_DATA_TO_FILE,
		.test_data_filepath =
			"/sdcard/rawdata/rawdata-test-data.txt",
		.num_invalid_node = 0,
		.invalid_nodes = NULL,
    ...
    int min = CTS_RAWDATA_TEST_VALUE_MIN; 
	int max = CTS_RAWDATA_TEST_VALUE_MAX;
    int ret;
    ktime_t start_time, end_time, delta_time;
		...
		struct device_attribute *attr, char *buf)
{
    ...
    struct cts_test_param test_param = {
		...
		.flags = CTS_TEST_FLAG_VALIDATE_DATA |
				 ...
				 CTS_TEST_FLAG_DUMP_TEST_DATA_TO_FILE,
		.test_data_filepath =
			"/sdcard/rawdata/noise-test-data.txt",
		.num_invalid_node = 0,
		.invalid_nodes = NULL,
		.priv_param = &priv_param,
		.priv_param_size = sizeof(priv_param),
