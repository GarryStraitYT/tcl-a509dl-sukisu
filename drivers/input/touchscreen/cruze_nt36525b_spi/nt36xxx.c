...
extern unsigned char ctp_module_name[128];
#endif
...
#ifdef CONFIG_TCT_DEVICEINFO
  	snprintf(ctp_module_name, 128, "NT36525B:TDT:0x%02X:AUC0650114C1", ts->fw_ver);
#endif
...
static int32_t nvt_ts_probe(struct spi_device *client)
{
	...
	input_set_capability(ts->input_dev, EV_KEY, KEY_GESTURE_PALMOUT);
...
static int fb_nvt_ts_resume(void *data) {
	nvt_ts_resume(data);
	return 0;
}
