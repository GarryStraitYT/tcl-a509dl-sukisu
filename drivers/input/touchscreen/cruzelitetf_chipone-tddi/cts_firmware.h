...
#else
static inline const struct cts_firmware *cts_request_firmware(struct cts_device *cts_dev,
...
static inline const struct cts_firmware *cts_request_firmware_from_fs(struct cts_device *cts_dev, const char *filepath) {return NULL;}
