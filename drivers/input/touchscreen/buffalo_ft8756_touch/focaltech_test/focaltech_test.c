...
//begin add by kun.zheng for task 10693673 oakland R on 2021/02/03
    ...
    struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    if ((dev_mkdir(mp_data_path, S_IRUGO | S_IWUSR)) != 0){
        FTS_TEST_ERROR("mkdir mp directory /sdcard/rawdata/ failed");
    }
