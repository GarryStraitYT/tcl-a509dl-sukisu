...
#ifdef CONFIG_TCT_PROJECT_BUFFALO
...
/* Begin meng.zhang power LCD bias gpio on 20210719 */
#if (defined CONFIG_TCT_PROJECT_BUFFALO)||(defined CONFIG_TCT_PROJECT_CHALLENGER_STYLU)
