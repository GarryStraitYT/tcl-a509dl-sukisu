...
// #ifdef VENDOR_EDIT
// shu5.zhang@tcl.com 2021/06/25 add for GPU frep governor
...
// shu5.zhang@tcl.com 2021/06/25 add for GPU frep governor
#ifdef CONFIG_GPU_DEVFREQ
	if(kbdev->mali_dev_data.callbacks->cl_boost_init)
		kbdev->mali_dev_data.callbacks->cl_boost_init(kbdev);
#endif
// #endif /* VENDOR_EDIT */
	return 0;
}
...
// shu5.zhang@tcl.com 2021/06/25 add for GPU frep governor
#ifdef CONFIG_GPU_DEVFREQ
		kbdev->pm.backend.metrics.values.gt_time_busy += ns_time;
#endif
// #endif /* VENDOR_EDIT */
...
// shu5.zhang@tcl.com 2021/06/25 add for GPU frep governor
	...
	// pr_err("%s c:%d v:%d f:%d \n",__FUNCTION__,compute_time,vertex_time,fragment_time);
	...
	mali_trace_clock_set_rate("mali-util", utilisation);
#endif
// #endif /* VENDOR_EDIT */
