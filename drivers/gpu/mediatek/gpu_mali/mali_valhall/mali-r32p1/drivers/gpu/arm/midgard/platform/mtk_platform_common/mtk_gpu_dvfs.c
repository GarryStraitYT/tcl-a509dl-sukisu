									...
									void *Util_Ex)
{
	...
	util_ex->util_3d = kbdev->pm.backend.metrics.util_3d;
	util_ex->util_ta = kbdev->pm.backend.metrics.util_ta;
	util_ex->util_compute = kbdev->pm.backend.metrics.util_compute;
	...
	// pr_err("%s %d pui32Loading=%d",__func__, __LINE__, *pui32Loading);
}
#endif
// #endif /* VENDOR_EDIT */
