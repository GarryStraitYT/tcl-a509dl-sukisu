...
// #else
#if defined(CONFIG_MALI_DEVFREQ) || defined(CONFIG_GPU_DEVFREQ)
// #endif /* VENDOR_EDIT */
...
// shu5.zhang@tcl.com 2021/06/24 add for GPU frep governor
#ifdef CONFIG_GPU_DEVFREQ
#include <platform/mt6833/mali_kbase_devfreq_callback.h>
#include <platform/mt6833/mali_kbase_config_devfreq.h>
#endif
// #endif /* VENDOR_EDIT */
...
// shu5.zhang@tcl.com 2021/06/24 add for GPU frep governor
#ifdef CONFIG_GPU_DEVFREQ
	struct mali_kbase_device_data mali_dev_data;
#endif
// #endif /* VENDOR_EDIT */
...
// #ifdef VENDOR_EDIT
// shu5.zhang@tcl.com 2021/08/23 add for GT
	struct list_head job_prio_list;
// #endif /* VENDOR_EDIT */
};
...
// shu5.zhang@tcl.com 2021/08/23 add for gmc
	...
	struct kbase_mali_ctx_data mali_ctx_data;
#endif
// #endif /* VENDOR_EDIT */
	struct shrinker         reclaim;
