					      ...
					      unsigned int size, bool slave)
{
	...
	ctlr->bus_num = -1;
//Begin added by liangjiaqiang for CIVICPL-2202 on 2022-08-09
#ifdef CONFIG_TOUCH_FEATURE_MUTI_SPI
	ctlr->num_chipselect = 4;
#else
	ctlr->num_chipselect = 1;
#endif
//End added by liangjiaqiang for CIVICPL-2202 on 2022-08-09
	ctlr->slave = slave;
