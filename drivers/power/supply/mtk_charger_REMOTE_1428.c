...
/* Begin added by hailong.chen for task 9777024 on 2020-10-20 */
#if defined(CONFIG_TCT_CHARGER)
extern int chg_enable;
#endif
/* End added by hailong.chen for task 9777024 on 2020-10-20 */
